...
public interface PrioritizationApiDocs {
    ...
    ResponseEntity<SuccessResponse<PrioritizationResponse>> prioritizeWeeklyToDo(
            @Parameter(
                    name = "Authorization",
    ...
    ResponseEntity<SuccessResponse<PrioritizationDailyResponse>> prioritizeDailyToDo(
            @Parameter(
                    name = "Authorization",
                    in = ParameterIn.HEADER,
                    description = "Bearer accesstoken",
